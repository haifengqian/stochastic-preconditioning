...
system('./generate 10 m1_50_cube.matrix');
system('./generate 15 m2_60_cube.matrix');
system('./generate 20 m3_70_cube.matrix');
system('./generate 25 m4_80_cube.matrix');
system('./generate 30 m5_90_cube.matrix');
system('./generate 35 m6_100_cube.matrix');
